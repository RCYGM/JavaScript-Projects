...
const forumCategory = (id) => {
    ...
    //porque aqui no se ejecuta un for of o un forEach ??? 
};

const timeAgo = (time) => {
    const currentTime = new Date(); // lastPost será la fecha de la última actividad en un tema.
    const lastPost = new Date(time); // currentTime representa la fecha y hora actuales.
